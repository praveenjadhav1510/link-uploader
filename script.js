function loadExternalContent() {
            var externalLink = 'https://example.com/external-content.html';
            fetch(externalLink)
                .then(response => response.text())
                .then(data => {
                    document.getElementById('codeSnippet').innerText = data;
                })
        ...
        function copyCode(n) {
            ...
            var copyButton = codeSnippet.parentElement.querySelector('.copy-button'); // Corrected selector
